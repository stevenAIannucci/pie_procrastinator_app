...
task2.setAttribute("oninput", "this.value = this.value.slice(0, 40)")
task2.setAttribute("maxlength", "40")
...
task3.setAttribute("oninput", "this.value = this.value.slice(0, 40)")
task3.setAttribute("maxlength", "40")
...
task4.setAttribute("oninput", "this.value = this.value.slice(0, 40)")
task4.setAttribute("maxlength", "40")
...
task5.setAttribute("oninput", "this.value = this.value.slice(0, 40)")
task5.setAttribute("maxlength", "40")
...
task6.setAttribute("oninput", "this.value = this.value.slice(0, 40)")
task6.setAttribute("maxlength", "40")
...
task7.setAttribute("oninput", "this.value = this.value.slice(0, 40)")
task7.setAttribute("maxlength", "40")
...
task8.setAttribute("oninput", "this.value = this.value.slice(0, 40)")
task8.setAttribute("maxlength", "40")
